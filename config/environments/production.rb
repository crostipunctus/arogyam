...
Rails.application.configure do
  ...
  # Serve only fingerprinted assets produced during deployment. Runtime
  # compilation is slower and broadens the production attack surface.
  ...
  # config.active_job.queue_name_prefix = "arogyam_production"
